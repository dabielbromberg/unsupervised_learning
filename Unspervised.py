...
# Start with your full dataset (with Median_House_Value)
df_temp = df_.copy()

# Add anomaly flags (these should be boolean or 0/1 numpy arrays)
df_temp['kmeans_anomaly'] = is_kmeans_anomaly.astype(int)
df_temp['gmm_anomaly'] = is_gmm_anomaly.astype(int)
df_temp['agglo_anomaly'] = is_agglo_anomaly.astype(int)
df_temp['iforest_anomaly'] = is_iforest_anomaly.astype(int)
